  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Delete Static IP</li>
      </ol>
    </section>
<?php
// get error 
...
?>
 ...
 <!-- general form elements disabled -->
          <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" action="ipdelete2.php"method="post">
                <!-- text input -->
                <div class="form-group">
                    <h4>The IP will automatically be released back into the address pool</h4>
					<?php
					if($error == 'email'){
						echo "$errorlabel";
					}else{
