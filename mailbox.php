  ...
  <div class="content-wrapper">
   ...
   <h1>
    ...
    <section class="content">
        <form role="form" action="deletemail.php"method="post">
        <div class="row">
        <div class="col-md-3">
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="mailbox.php?mailfolder=[Gmail]/Drafts"><i class="fa fa-file-text-o"></i> Drafts</a></li>
                <li><a href="mailbox.php?mailfolder=[Gmail]/Spam"><i class="fa fa-filter"></i> Junk</a>
                </li>
                <li><a href="mailbox.php?mailfolder=[Gmail]/Trash"><i class="fa fa-trash-o"></i> Trash</a></li>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
