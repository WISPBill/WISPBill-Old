...
CREATE TABLE IF NOT EXISTS `wispbillv2`.`customer_locations` (
  `idcustomer_locations` INT NOT NULL COMMENT '',
  `billing_mode` VARCHAR(45) NULL COMMENT '',
  `lat` VARCHAR(45) NULL COMMENT '',
  `lon` VARCHAR(45) NULL COMMENT '',
  ...
  `customer_info_idcustomer_info` INT(11) NOT NULL COMMENT '',
  `devices_iddevices` INT(11) NOT NULL COMMENT '',
  `customer_plans_idcustomer_plans` INT(11) NOT NULL COMMENT '',
  PRIMARY KEY (`idcustomer_locations`, `customer_info_idcustomer_info`, `devices_iddevices`, `customer_plans_idcustomer_plans`)  COMMENT '',
