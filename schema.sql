...
CREATE TABLE IF NOT EXISTS `wispbillv2`.`tasks` (
  ...
  `start_date_time` DATETIME NULL DEFAULT NULL COMMENT '',
  `end_date_time` DATETIME NULL DEFAULT NULL COMMENT '',
  `real_start_date_time` DATETIME NULL DEFAULT NULL COMMENT '',
  `real_end_date_time` DATETIME NULL DEFAULT NULL COMMENT '',
  `task_length` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `admin_users_idadmin` INT(11) NOT NULL COMMENT '',
  `ticket_idticket` INT(11) NOT NULL COMMENT '',
