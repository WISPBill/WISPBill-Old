...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Delete Customer and All records associated with them
      </h1>
      <ol class="breadcrumb">
...
?>
 ...
 <!-- general form elements disabled -->
          <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" action="deletecustomer2.php"method="post">
                <!-- text input -->
                <div class="form-group">
                    <h4>This should not be done until CPE is recovered</h4>
					<?php
