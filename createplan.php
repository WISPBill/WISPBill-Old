    ...
    <section class="content">
       ...
       <!-- general form elements disabled -->
          <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" action="createplan2.php"method="post">
                <!-- text input -->
			   ...
			   <div class="form-group">
					...
					if($error == 'price'){
						...
						echo '<label>Plan Price</label>';
					}
					?>
                  <input  class="form-control" type="number" name="price" min="0" placeholder="Enter Plan Price" required>
                </div>
			   ...
			   <div class="form-group">
                <?php
					if($error == 'up'){
						...
						echo '<label>Max upload bandwidth in kilobits per second</label>';
					}
					?>
                  
                  <input class="form-control" type="number" name="up" min="0" placeholder="Enter Upload in Kbps" required>
                </div>
               ...
               <div class="form-group">
                <?php
					if($error == 'down'){
						...
						echo '<label>Max download bandwidth in kilobits per second</label>';
					}
					?>
                  
                  <input class="form-control" type="number" name="down" min="0" placeholder="Enter Download in Kbps" required>
                </div>
