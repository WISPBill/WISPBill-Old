  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Ticket Note</li>
      </ol>
    </section>

    <!-- Main content -->
	 <form role="form" action="createticketnote2.php"method="post">
	<div class="row">
        <div class="col-xs-12">
...
$error = $_SESSION['exitcodev2'];
                if($error =='id'){
				 ...
				 echo '<h3 class="box-title">Select a Ticket to Make a Note</h3>';
				}
...
?>
  ...
  */
                if ($result = $mysqli->query("SELECT * FROM  `ticket` WHERE MOD(  `status` , 2 ) =1 or `status` = '0'")) {
      /* fetch associative array */
                ...
                <tr>
                 ...
                 <div class="form-group">
                  <?php
					...
					?>
                  <textarea class="form-control" rows="5" placeholder="Enter your note" name="text1"></textarea>
                </div>
