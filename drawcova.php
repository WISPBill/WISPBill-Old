  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Draw Coverage</li>
      </ol>
    </section>

    <!-- Main content -->
	 <form role="form" action="drawcov.php"method="post">
	<div class="row">
        <div class="col-xs-12">
...
$error = $_SESSION['exitcodev2'];
                if($error =='site'){
				 echo '<h3 class="box-title" style="color: red;">You need to Select a Site</h3>';
				}else{
				 echo '<h3 class="box-title">Select a Site</h3>';
				}
?> 
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
				 <?php
                if ($result = $mysqli->query("SELECT * FROM `location` WHERE `coverage` is NULL")) {
      /* fetch associative array */
    ...
    while ($row = $result->fetch_assoc()) {
     ...
     $type= $row["type"];
     echo" <tr>
    <td><input type='radio' name='id' value=$id2 unchecked></td>
    <td>$name2</td> 
    <td>$lat</td>
    <td>$lon</td> 
    <td>$type</td>
