...
?>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
	 <form role="form" action="linkdevice2.php"method="post">
	<div class="row">
        <div class="col-xs-12">
...
$error = $_SESSION['exitcodev2'];
                if($error =='dev'){
				 echo '<h3 class="box-title" style="color: red;">You need to Select a Device</h3>';
				}else{
				 echo '<h3 class="box-title">Select a Device</h3>';
				}
				$_SESSION['exitcodev2'] = '';
?> 
            </div>
