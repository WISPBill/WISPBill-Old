...
USE `wispbillv2`;
CREATE  OR REPLACE VIEW `routermgmt` AS
    (SELECT 
		a.iddevices,
        b.username,
        b.password,
    ...
    FROM
        devices a,
        device_credentials b,
        device_ports c
    WHERE
        a.iddevices = b.devices_iddevices = c.devices_iddevices
            AND c.use = 'mgmt'
            AND a.type = 'router'
            AND a.field_status = 'tower')
