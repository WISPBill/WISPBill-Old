...
?>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
	 <form role="form" action="troubleshooting2.php"method="post">
	<div class="row">
        <div class="col-xs-12">
...
$error = $_SESSION['exitcodev2'];
                if($error =='id'){
				 ...
				 echo '<h3 class="box-title">Search Customers</h3>';
				}
              ...
              <div class="form-group">
                  <?php
					if($error == 'medium'){
						...
						echo '<label>Contact Medium</label>';
					}
					?>
                  <select class="form-control" name="medium" required>
					<option value='' selected disabled>Please Select Contact Medium</option>
               ...
               <div class="form-group">
					...
					if($error == 'issue'){
						...
						echo '<label>Short Description of Issue</label>';
					}
					?>
                  <input type="text" class="form-control" name="issue" placeholder="Enter a short Description of Issue" required>
                </div>
              
			  <div class="box-footer">
                <button type="submit" class="btn btn-primary">Log Contact and View Customer Record</button>
              </div>
            </div>
            <!-- /.box-body -->
          </div>
