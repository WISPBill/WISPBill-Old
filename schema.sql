...
-- -----------------------------------------------------
-- Table `wispbillv2`.`admin_hours`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wispbillv2`.`admin_hours` (
  `idadmin_hours` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
  `day_of_week` TINYINT(4) NULL DEFAULT NULL COMMENT '',
  `start` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `end` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `admin_users_idadmin` INT(11) NOT NULL COMMENT '',
  PRIMARY KEY (`idadmin_hours`)  COMMENT '',
  INDEX `fk_admin_hours_admin_users1_idx` (`admin_users_idadmin` ASC)  COMMENT '',
  CONSTRAINT `fk_admin_hours_admin_users1`
...
-- -----------------------------------------------------
-- Table `wispbillv2`.`admin_settings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wispbillv2`.`admin_settings` (
  `idadmin_settings` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
  `setting_name` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `value` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `admin_users_idadmin` INT(11) NOT NULL COMMENT '',
  PRIMARY KEY (`idadmin_settings`)  COMMENT '',
  INDEX `fk_admin_settings_admin_users1_idx` (`admin_users_idadmin` ASC)  COMMENT '',
  CONSTRAINT `fk_admin_settings_admin_users1`
    FOREIGN KEY (`admin_users_idadmin`)
    REFERENCES `wispbillv2`.`admin_users` (`idadmin`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `wispbillv2`.`customer_locations`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wispbillv2`.`customer_locations` (
  `idcustomer_locations` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
  `billing_mode` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `lat` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `lon` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `street_address` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `city` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `zip` INT(11) NULL DEFAULT NULL COMMENT '',
  `state` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `customer_info_idcustomer_info` INT(11) NOT NULL COMMENT '',
  `devices_iddevices` INT(11) NOT NULL COMMENT '',
  `customer_plans_idcustomer_plans` INT(11) NULL DEFAULT NULL COMMENT '',
  PRIMARY KEY (`idcustomer_locations`, `customer_info_idcustomer_info`, `devices_iddevices`)  COMMENT '',
  INDEX `fk_customer_locations_devices1_idx` (`devices_iddevices` ASC)  COMMENT '',
  INDEX `fk_customer_locations_customer_plans1_idx` (`customer_plans_idcustomer_plans` ASC)  COMMENT '',
  INDEX `fk_customer_locations_customer_info1_idx` (`customer_info_idcustomer_info` ASC)  COMMENT '',
  CONSTRAINT `fk_customer_locations_customer_info1`
    FOREIGN KEY (`customer_info_idcustomer_info`)
    REFERENCES `wispbillv2`.`customer_info` (`idcustomer_info`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_customer_locations_customer_plans1`
    FOREIGN KEY (`customer_plans_idcustomer_plans`)
    REFERENCES `wispbillv2`.`customer_plans` (`idcustomer_plans`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_customer_locations_devices1`
    FOREIGN KEY (`devices_iddevices`)
    REFERENCES `wispbillv2`.`devices` (`iddevices`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `wispbillv2`.`customer_users` (
  ...
  `pin` VARCHAR(255) NULL DEFAULT NULL COMMENT '',
  `customer_info_idcustomer_info` INT(11) NOT NULL COMMENT '',
  PRIMARY KEY (`idcustomer_users`, `customer_info_idcustomer_info`)  COMMENT '',
  INDEX `fk_customer_users_customer_info1_idx` (`customer_info_idcustomer_info` ASC)  COMMENT '',
  CONSTRAINT `fk_customer_users_customer_info1`
    FOREIGN KEY (`customer_info_idcustomer_info`)
    REFERENCES `wispbillv2`.`customer_info` (`idcustomer_info`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `wispbillv2`.`ip_networks`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wispbillv2`.`ip_networks` (
  `idip_networks` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
  `network` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `subnet` SMALLINT(6) NULL DEFAULT NULL COMMENT '',
  PRIMARY KEY (`idip_networks`)  COMMENT '')
ENGINE = InnoDB
AUTO_INCREMENT = 3
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `wispbillv2`.`ip_address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wispbillv2`.`ip_address` (
  `idip_address` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
  `address` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `status` TINYINT(4) NULL DEFAULT NULL COMMENT '',
  `ip_networks_idip_networks` INT(11) NOT NULL COMMENT '',
  `devices_iddevices` INT(11) NULL DEFAULT NULL COMMENT '',
  `dhcp_mac` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  PRIMARY KEY (`idip_address`)  COMMENT '',
  INDEX `fk_ip_address_ip_networks1_idx` (`ip_networks_idip_networks` ASC)  COMMENT '',
  INDEX `fk_ip_address_devices1_idx` (`devices_iddevices` ASC)  COMMENT '',
  INDEX `Status` (`status` ASC)  COMMENT '',
  CONSTRAINT `fk_ip_address_devices1`
    FOREIGN KEY (`devices_iddevices`)
    REFERENCES `wispbillv2`.`devices` (`iddevices`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ip_address_ip_networks1`
    FOREIGN KEY (`ip_networks_idip_networks`)
    REFERENCES `wispbillv2`.`ip_networks` (`idip_networks`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 36
...
-- -----------------------------------------------------
-- Table `wispbillv2`.`links`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wispbillv2`.`links` (
  `idlinks` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
  `capacity` INT(11) NULL DEFAULT NULL COMMENT '',
  `status` TINYINT(4) NULL DEFAULT NULL COMMENT '',
  `master_site` INT(11) NOT NULL COMMENT '',
  `slave_site` INT(11) NOT NULL COMMENT '',
  `master_port` INT(11) NOT NULL COMMENT '',
  `slave_port` INT(11) NOT NULL COMMENT '',
  PRIMARY KEY (`idlinks`)  COMMENT '',
  INDEX `fk_links_location1_idx` (`master_site` ASC)  COMMENT '',
  INDEX `fk_links_location2_idx` (`slave_site` ASC)  COMMENT '',
  INDEX `fk_links_device_ports1_idx` (`master_port` ASC)  COMMENT '',
  INDEX `fk_links_device_ports2_idx` (`slave_port` ASC)  COMMENT '',
  CONSTRAINT `fk_links_device_ports1`
    FOREIGN KEY (`master_port`)
    REFERENCES `wispbillv2`.`device_ports` (`iddevice_ports`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_links_device_ports2`
    FOREIGN KEY (`slave_port`)
    REFERENCES `wispbillv2`.`device_ports` (`iddevice_ports`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_links_location1`
    FOREIGN KEY (`master_site`)
    REFERENCES `wispbillv2`.`location` (`idlocation`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_links_location2`
    FOREIGN KEY (`slave_site`)
    REFERENCES `wispbillv2`.`location` (`idlocation`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `wispbillv2`.`static_leases` (
  ...
  `customer_locations_idcustomer_locations` INT(11) NOT NULL COMMENT '',
  PRIMARY KEY (`idstatic_leases`, `customer_locations_idcustomer_locations`)  COMMENT '',
  INDEX `fk_static_leases_DHCP_Servers1_idx` (`DHCP_Servers_idDHCP_Servers` ASC)  COMMENT '',
  INDEX `fk_static_leases_customer_locations1_idx` (`customer_locations_idcustomer_locations` ASC)  COMMENT '',
  CONSTRAINT `fk_static_leases_DHCP_Servers1`
    ...
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_static_leases_customer_locations1`
    FOREIGN KEY (`customer_locations_idcustomer_locations`)
    REFERENCES `wispbillv2`.`customer_locations` (`idcustomer_locations`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `wispbillv2`.`ticket_note` (
  ...
  INDEX `ticket_notes_ibfk_1` (`ticket_idticket` ASC)  COMMENT '',
...
-- -----------------------------------------------------
-- Placeholder table for view `wispbillv2`.`routermgmt`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wispbillv2`.`routermgmt` (`id` INT);

-- -----------------------------------------------------
-- View `wispbillv2`.`routermgmt`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wispbillv2`.`routermgmt`;
USE `wispbillv2`;
CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `wispbillv2`.`routermgmt` AS (select `a`.`iddevices` AS `iddevices`,`b`.`username` AS `username`,`b`.`password` AS `password`,`b`.`IV` AS `IV`,`c`.`ip_address` AS `ip_address` from ((`wispbillv2`.`devices` `a` join `wispbillv2`.`device_credentials` `b`) join `wispbillv2`.`device_ports` `c`) where (((`a`.`iddevices` = `b`.`devices_iddevices`) = `c`.`devices_iddevices`) and (`c`.`use` = 'mgmt') and (`a`.`type` = 'router') and (`a`.`field_status` = 'tower')));
