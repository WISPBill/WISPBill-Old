  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Network</li>
      </ol>
    </section>
<?php
// get error 
    ...
    <section class="content">
         ...
         <!-- general form elements disabled -->
          <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" action="addnetwork2.php"method="post">
                <!-- text input -->
            ...
            <div class="form-group">
                <?php
					if($error == 'ip'){
						...
						echo '<label>Enter IP Network</label>';
					}
					?>
                ...
                <?php
					if($error == 'mask'){
						...
						echo '<label>Enter CIDR (8 thru 32)</label>';
					}
					?>

                <div class="input-group">
               
                  <input name="mask" type="number" class="form-control" min="8" max="32" required>
                </div>
                <!-- /.input group -->
              </div>
