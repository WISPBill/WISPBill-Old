...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Configure Router Monitoring  
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Level</a></li>
        <li class="active">Router Monitoring</li>
      </ol>
    </section>
<?php
// get error 
...
?>
    ...
    <section class="content">
         ...
         <!-- general form elements disabled -->
          <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" action="configrouter2.php"method="post">
                <!-- text input -->
                
                <div class="form-group">
					<?php
                    if($error == 'all'){
                        echo "<h1 style='color: red;'>The Router did not respond via SSH</h1>";
                    }else{
                        // Nothing
                    }
					if($error == 'name'){
                ...
                <div class="form-group">
					...
					if($error == 'pass'){
						...
						echo '<label>Router Password</label>';
					}
					?>
            ...
            <div class="form-group">
                <?php
					if($error == 'ip'){
						...
						echo '<label>Enter Management IP</label>';
					}
					?>
    ...
    /* fetch associative array */
                ...
                if($error == 'site'){
						...
						echo '<label>Select the Router</label>';
					}
                echo '<select class="form-control" name="router"  required>
				  <option value="" selected disabled>Please Select Router</option>';
    while ($row = $result->fetch_assoc()) {
        $id = $row["iddevices"];
        $name = $row["name"];
