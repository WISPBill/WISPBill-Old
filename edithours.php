...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      Edit your work hours
      </h1>
      <ol class="breadcrumb">
        <li><a href="dashbored.php"><i class="fa fa-dashboard"></i> Dashbored</a></li>
        <li class="active">Edit Hours</li>
      </ol>
    </section>

    <!-- Main content -->
	 <form role="form" action="edithours2.php"method="post">
	<div class="row">
        <div class="col-xs-12">
...
?>
            ...
            <div class="box-body">
               ...
               <div class="form-group">
                  <?php
					if($error == 'change'){
						...
						echo '<label>Which Day do you Want to Change?</label>';
					}
					?>
                  <select class="form-control" name="day" required>
					<option value='' selected disabled>Please Select a Day of the Week</option>
              ...
              <div class="form-group">
                  <?php
					if($error == 'work'){
						...
						echo '<label>Will you Work on this day?</label>';
					}
					?>
              ...
              <span id="newtime" style="display:none;">
              <div class="bootstrap-timepicker">
                <div class="form-group">
                  <label>New Start Time</label>

                  <div class="input-group">
                    <input type="text" class="form-control timepicker" name="newstart">
               ...
               <div class="bootstrap-timepicker">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control timepicker" name="newend">
