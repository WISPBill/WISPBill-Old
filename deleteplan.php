...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      Do not Delete all Plan's This will take some time
      </h1>
      <ol class="breadcrumb">
        <li><a href="dashbored.php"><i class="fa fa-dashboard"></i> Dashbored</a></li>
        <li class="active">Delete Plan</li>
      </ol>
    </section>

    <!-- Main content -->
	 <form role="form" action="deleteplan2.php"method="post">
	<div class="row">
        <div class="col-xs-12">
...
$error = $_SESSION['exitcodev2'];
                if($error =='site'){
				 ...
				 echo '<h3 class="box-title">Select a Plan to Delete</h3>';
				}
?> 
            </div>
            <!-- /.box-header -->
...
?>
    ...
    /* fetch associative array */
                ...
                if($error == 'con'){
						...
						echo '<label>Plan to Move Users to</label>';
					}
