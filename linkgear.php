...
?>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
	 <form role="form" action="linkgear2.php"method="post">
	<div class="row">
        <div class="col-xs-12">
...
?> 
    ...
    /* fetch associative array */
                ...
                echo '<select class="form-control" name="site" required>
        ...
        echo'  <label class="control-label" for="inputError">Datebase
			   ...
			   <?php
			    if($error =='dev'){
				 ...
				 echo '<label>Select a Device</label>';
				}
			   ?>
			   <table id="example1" class="table table-bordered table-striped">
                ...
                if ($result = $mysqli->query("SELECT * FROM `devices`
                             ...
                             `type` != 'cpe' and `type` != 'router' and `field_status` ='inventory'")) {
      /* fetch associative array */
