  ...
  <div class="content-wrapper">
	...
	<div class="box">
            <div class="box-header">
				...
				<h3 class="box-title">Static IPs</h3>
...
if ($result = $mysqli->query("SELECT * FROM  `static_leases` ")) {
      /* fetch associative array */
   ...
   if ($result = $mysqli->query("SELECT * FROM `device_ports` WHERE `iddevice_ports` = '$portid'")) {
    /* fetch associative array */
     while ($row = $result->fetch_assoc()) {
...
if ($result = $mysqli->query("SELECT * FROM `devices` WHERE `iddevices` = '$did'")) {
    /* fetch associative array */
     while ($row = $result->fetch_assoc()) {
    $siteid = $row["location_idlocation"];
}
       /* free result set */
    $result->close();
}// end if
if ($result = $mysqli->query("SELECT * FROM `location` WHERE `idlocation` = '$siteid'")) {
    /* fetch associative array */
     while ($row = $result->fetch_assoc()) {
    $site = $row["name"];
}
